...
import { getEntity } from './winner.reducer';
import { IWinner } from 'app/shared/model/winner.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IWinnerDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class WinnerDetail extends React.Component<IWinnerDetailProps> {
  componentDidMount() {
    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to={`/entity/winner/${winnerEntity.id}/edit`} replace color="primary">
